...
public class UiIntentActions {
    ...
    public static final String LIST_STREQUENT_ACTION =
            "com.nwagu.contacts.action.LIST_STREQUENT";
    ...
    public static final String TITLE_EXTRA_KEY =
            "com.nwagu.contacts.extra.TITLE_EXTRA";
    ...
    public static final String FILTER_TEXT_EXTRA_KEY =
            "com.nwagu.contacts.extra.FILTER_TEXT";
    ...
    public static final String TARGET_CONTACT_ID_EXTRA_KEY
            = "com.nwagu.contacts.action.CONTACT_ID";

    public static final String TARGET_CONTACT_IDS_EXTRA_KEY
            = "com.nwagu.contacts.action.CONTACT_IDS";
}